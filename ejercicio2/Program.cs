internal class Program
{
    ...
    {
        Client client = new Client("Pipe Nieto", "17348628A", 5000, 15000);

        
        Supplier supplier = new Supplier("MR Robot Tech Supplies Co.", "98265736B");
        ...
        Project project = new Project("Mobile App", "Develop a mobile application", 30, 500, 5, 10, client, supplier);
